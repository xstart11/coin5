...
QBO now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<qbo_address\> \<monthly_payment_qbo\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ QBO, _12_ times over the course of a year totaling _24000_ QBO.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<qbo_address\> \<monthly_payment_qbo\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` QBO.
 ...
 * vote-many          - Vote on a QBO initiative
 * vote-alias         - Vote on a QBO initiative
 * vote               - Vote on a QBO initiative/budget

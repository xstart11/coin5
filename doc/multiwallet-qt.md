...
In order to support loading of multiple wallets in qbo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qbo.cpp.
...
Changes to qbo.cpp
----------------------
qbo.cpp is the entry point into qbo-qt, and as such, will require some minor modifications to provide hooks for

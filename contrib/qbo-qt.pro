...
RESOURCES += src/qt/qbo.qrc src/qt/qbo_locale.qrc

TRANSLATIONS += src/qt/locale/qbo_bg.ts \
                src/qt/locale/qbo_de.ts \
                src/qt/locale/qbo_en.ts \
                src/qt/locale/qbo_es.ts \
                src/qt/locale/qbo_fi.ts \
                src/qt/locale/qbo_fr.ts \
                src/qt/locale/qbo_it.ts \
                src/qt/locale/qbo_ja.ts \
                src/qt/locale/qbo_pl.ts \
                src/qt/locale/qbo_pt.ts \
                src/qt/locale/qbo_ru.ts \
                src/qt/locale/qbo_sk.ts \
                src/qt/locale/qbo_sv.ts \
                src/qt/locale/qbo_vi.ts \
                src/qt/locale/qbo_zh_CN.ts \
                src/qt/locale/qbo_zh_TW.ts

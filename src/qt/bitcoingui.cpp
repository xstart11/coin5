                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QABIO-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QBO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qbo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QBO Core"), this);
    aboutAction->setStatusTip(tr("Show information about QBO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QBO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QBO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QBO addresses"));
    ...
    openAction->setStatusTip(tr("Open a QBO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    // Links
    openWebsite1 = new QAction(QIcon(":/icons/website"), tr("&WebSite"), this);
    openWebsite1->setStatusTip(tr("Website"));
    openWebsite2 = new QAction(QIcon(":/icons/mnf"), tr("&MNF platform"), this);
    openWebsite3 = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk"), this);
    openWebsite4 = new QAction(QIcon(":/icons/twitter"), tr("&Twitter"), this);
    openWebsite5 = new QAction(QIcon(":/icons/discord"), tr("&Discord"), this);
    openWebsite6 = new QAction(QIcon(":/icons/telegram"), tr("&Telegram"), this);
    openWebsite7 = new QAction(QIcon(":/icons/facebook"), tr("&Facebook"), this);
    openWebsite8 = new QAction(QIcon(":/icons/github"), tr("&Github"), this);
    openWebsite9 = new QAction(QIcon(":/icons/explorer"), tr("&Explorer"), this);
    openWebsite10 = new QAction(QIcon(":/icons/whitepaper"), tr("&Whitepaper"), this);

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QBO Core help message to get a list with possible QBO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QBO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QBO network", "", count));
}
...
{
    QString strTitle = tr("QBO Core"); // default title

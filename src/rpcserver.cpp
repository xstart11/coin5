...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QBO features */
        {"qbo", "masternode", &masternode, true, true, false},
        {"qbo", "masternodelist", &masternodelist, true, true, false},
        {"qbo", "mnbudget", &mnbudget, true, true, false},
        {"qbo", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"qbo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"qbo", "mnsync", &mnsync, true, true, false},
        {"qbo", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use qbod, or the -server option to qbo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> qbo-cli " + methodname + " " + args + "\n";
}

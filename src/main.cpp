...
#if defined(NDEBUG)
#error "QBO cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "QBO Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight > 1 && nHeight <= 15555) {
        nSubsidy = 1 * COIN;
    } else {
        nSubsidy = 75 * COIN;
    }
